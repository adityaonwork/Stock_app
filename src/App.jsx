        ...
        <div className={`premium-sidebar ${rightPanelOpen ? 'open' : ''}`}>
          ...
          <div className="sidebar-menu">
            <div className="menu-item">
              ...
              <div>
                <div className="menu-title">Secure login</div>
                <div className="menu-subtitle">Voiceprint verification with anti-spoofing defense</div>
              </div>
            </div>
            ...
            <div className="menu-item">
              ...
              <div>
                <div className="menu-title">Live capture</div>
                <div className="menu-subtitle">Real-time audio analysis</div>
              </div>
            </div>
            ...
            <div className="menu-item">
              ...
              <div>
                <div className="menu-title">Auth metrics</div>
                <div className="menu-subtitle">Embedding quality & anti-spoof scores</div>
              </div>
            </div>
            ...
            <div className="menu-item">
              ...
              <div>
                <div className="menu-title">Enrollment profile</div>
                <div className="menu-subtitle">Manage your voiceprint template</div>
              </div>
            </div>
            ...
            <div className="menu-item">
              ...
              <div>
                <div className="menu-title">Banking use case</div>
                <div className="menu-subtitle">Voice-authenticated transactions</div>
              </div>
            </div>
          </div>
        </div>
